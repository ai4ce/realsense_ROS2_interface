...
"""Launch the entire realsense system."""
import os
import yaml
...
configurable_parameters = [{'name': 'camera_namespace',             'default': 'xArm6', 'description': 'namespace for camera'},
                           ...
                           {'name': 'save_json_path',               'default': '/home/irving/Desktop/save_folder/realsense_transform.json', 'description': 'path to the logging json file. This is different from RealSense JSON parameter. If empty, no logging will be done'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '1280x720x15', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '1280x720x15', 'description': 'depth stream color profile'},
                           {'name': 'depth_module.depth_profile',   'default': '1280x720x15', 'description': 'depth stream profile'},
...
def set_configurable_parameters(parameters):
    para_dict = dict([(param['name'], LaunchConfiguration(param['name'])) for param in parameters])
    return para_dict
